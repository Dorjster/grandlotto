...
const Status = () => {
  return (
    <div className="absolute top-[60%] md:top-[90%] w-[70%] bg-[#27438C] py-[5px] md:py-[35px] rounded-[15px] justify-between px-[20px] z-10">
      <div className="grid grid-cols-1 gap-1 sm:grid-cols-1 sm:gap-1 md:grid-cols-3 md:gap-3">
