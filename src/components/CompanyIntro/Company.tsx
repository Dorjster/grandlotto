  ...
  return (
    <div className="  relative z-0">
      ...
      <div className=" flex justify-center items-center ">
        <div className="bg-white shadow-2xl w-[70%] absolute top-[75%] z-10 rounded-[15px] p-20">
          {" "}
          <CompanyIntro
            h1="Компанийн"
            h2="танилцуулга"
          ...
          />
          <hr className="border-1.5 border-dotted border-gray-400 mb-[30px]" />
          <Association />
        </div>
        <div className="bg-[#27438C] shadow-2xl w-[70%] absolute top-[273%] z-0 rounded-[15px] p-20">
          <Lottery />
        </div>
        <div className=" absolute top-[400%] w-[70%]">
          <GraphContainer />
        </div>
      </div>
    </div>
